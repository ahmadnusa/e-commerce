...
export default function CartItem({ product, title, metaImage, qty, addItemToCart }) {
  ...
  return (
    <li className={classes.item}>
      <Link href={`'/products/${product.slug}`} className={classes.medaiWrapper}>
      ...
      <div className={classes.itemDetails}>
        ...
        <div className={classes.quantity}>
          <div className={classes.quantityBtn} onClick={decrementQty}>
            <Image src="/assets/icons/minus.svg" alt="minus" height={24} width={24} />
          </div>
          <input
            name="qty"
            type="text"
          ...
          <div className={classes.quantityBtn} onClick={incrementQty}>
            <Image src="/assets/icons/plus.svg" alt="plus" height={24} width={24} />
          </div>
        </div>
      </div>
